...
Adaptor.prototype.detectLocator = function() {
  var opts = {
        n: this.locatorOpts.n || 200,
        m: this.locatorOpts.m || 1,
        pcnt: this.locatorOpts.pcnt || 0
  };

  this.setDataStreaming(['locator', 'accelOne', 'velocity'], opts);
...
Adaptor.prototype.setDataStramming = function(dataSources, opts) {
  for (var ds in dataSources) {
    mask1 = (dataSources1[ds]) ? mask1 ^ dataSources1[ds] : mask1;
    mask2 = (dataSources2[ds]) ? mask2 ^ dataSources2[ds] : mask2;
  }
